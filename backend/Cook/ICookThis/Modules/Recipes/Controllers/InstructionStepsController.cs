...
namespace ICookThis.Modules.Recipes.Controllers
{
    ...
    public class InstructionStepsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<InstructionStepResponse>> Create(int recipeId, [FromBody] InstructionStepRequest dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<InstructionStepResponse>> Update(int recipeId, int id, [FromBody] InstructionStepRequest dto)
        {
